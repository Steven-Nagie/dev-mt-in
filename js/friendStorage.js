angular.module('devMtnSocial').service('friendService', function() {
  ...
  this.createFriends('Sally Rally', 'My name is Sally.', 'I left my heart in San Francsico.', 'https://images.unsplash.com/photo-1473163928189-364b2c4e1135?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&s=0721657b46ce27df52955f73818ab5b7');
  ...
  this.createFriends("Blackbeard", "Y'ARRR!", "YYY'AAAAAARRRRRRRRR", "https://upload.wikimedia.org/wikipedia/commons/f/f7/General_History_of_the_Pyrates_-_Blackbeard_the_Pirate_(1725).jpg");
